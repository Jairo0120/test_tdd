...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=user2, name='AppleJuice')
    ...
    def test_create_ingredient_invalid(self):
        """Test create new ingredient with invalid data"""
        payload = {'name': ''}
    ...
    def test_retrieve_ingredients_assigned_to_recipes(self):
        ...
        ingredient1 = Ingredient.objects.create(user=self.user,
                                                name='Breakfast')
        ingredient2 = Ingredient.objects.create(user=self.user, name='Launc')
    ...
    def test_retrieve_ingredients_assigned_unique(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user,
                                               name='Breakfast')
        Ingredient.objects.create(user=self.user, name='Launch')
